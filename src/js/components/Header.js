    ...
    return `
      <div class="header-inner">
        ...
        <div class="header-actions">
          ...
          <a href="#admin-products" class="btn-icon" id="header-admin-btn" aria-label="Painel de Produtos" title="Painel de Produtos" style="display: flex; align-items: center; justify-content: center; text-decoration: none;">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
